...
def get_book_details(book_url):
    ...
    # Extract availability and number of items in stock
...
# Function to get book URLs from a single page
...
# Function to get document (HTML content) from a URL
def get_doc(url):
...
# Function to scrape multiple pages and get all book details
